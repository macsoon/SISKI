...
reinforcement-atmos-desc = Наймите специалиста по атмосфере, чтобы воздух оставался пригодным для дыхания, а форон — под контролем. Инструменты включены. Минимальное время прибытия — три минуты.
